...
var author$project$Main$BlogPostPage = function (a) {
	return {$: 'BlogPostPage', a: a};
};
...
var author$project$Page$BlogPost$get = F2(
...
var author$project$Page$BlogPost$elmBlogGithubPart1 = {
	...
	contentString: '',
	entry: author$project$Page$BlogPost$ElmBlogGithubPart1,
	getContentUrl: 'https://absynce.github.io/posts/elm-blog-github-part-1.md',
	publishedOn: '2018-01-13',
	slug: author$project$Page$BlogPost$Slug('elm-blog-github-part-1-host-elm-code-on-github'),
	title: 'elm-blog-github - Part 1 - Host Elm code on GitHub'
};
var author$project$Page$BlogPost$ElmBlogGithubPart0 = {$: 'ElmBlogGithubPart0'};
var author$project$Page$BlogPost$elmBlogGithubPart0 = {
	author: 'Jared M. Smith',
	contentString: '',
	entry: author$project$Page$BlogPost$ElmBlogGithubPart0,
	getContentUrl: 'https://absynce.github.io/posts/elm-blog-github-part-0.md',
	publishedOn: '2018-01-04',
	slug: author$project$Page$BlogPost$Slug('elm-blog-github-part-0-introduction'),
	title: 'elm-blog-github - Part 0 - Introduction'
};
var author$project$Page$BlogPost$ElmBlogGithubPart2 = {$: 'ElmBlogGithubPart2'};
var author$project$Page$BlogPost$elmBlogGithubPart2 = {
	author: 'Jared M. Smith',
	contentString: '',
	entry: author$project$Page$BlogPost$ElmBlogGithubPart2,
	getContentUrl: 'https://absynce.github.io/posts/elm-blog-github-part-2.md',
	publishedOn: '2018-01-20',
	slug: author$project$Page$BlogPost$Slug('elm-blog-github-part-2-add-title-and-content-areas'),
	title: 'elm-blog-github - Part 2 - Add title and content areas'
};
var author$project$Page$BlogPost$ElmBlogGithubPart3 = {$: 'ElmBlogGithubPart3'};
var author$project$Page$BlogPost$elmBlogGithubPart3 = {
	author: 'Jared M. Smith',
	contentString: '',
	entry: author$project$Page$BlogPost$ElmBlogGithubPart3,
	getContentUrl: 'https://absynce.github.io/posts/elm-blog-github-part-3.md',
	publishedOn: '2018-01-27',
	slug: author$project$Page$BlogPost$Slug('elm-blog-github-part-3-add-multiple-pages'),
	title: 'elm-blog-github - Part 3 - Add multiple pages'
};
var author$project$Page$BlogPost$posts = _List_fromArray(
	[author$project$Page$BlogPost$elmBlogGithubPart0, author$project$Page$BlogPost$elmBlogGithubPart1, author$project$Page$BlogPost$elmBlogGithubPart2, author$project$Page$BlogPost$elmBlogGithubPart3]);
...
var author$project$Page$BlogPost$latest = A2(
	elm$core$Maybe$withDefault,
	author$project$Page$BlogPost$elmBlogGithubPart1,
	elm$core$List$head(
		A2(
...
var author$project$Page$BlogPost$postsBySlug = elm$core$Dict$fromList(
	A2(
		elm$core$List$map,
		function (blogPost) {
			return _Utils_Tuple2(
				author$project$Page$BlogPost$slugToString(blogPost.slug),
				blogPost);
		},
		author$project$Page$BlogPost$posts));
	...
	function (route, model) {
		if (route.$ === 'Just') {
			if (route.a.$ === 'Home') {
				...
				var maybeBlogPost = A2(elm$core$Dict$get, slugString, author$project$Page$BlogPost$postsBySlug);
				if (maybeBlogPost.$ === 'Just') {
					var blogPost = maybeBlogPost.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$BlogPostPage(blogPost)
							}),
						A2(author$project$Page$BlogPost$get, author$project$Main$BlogPostLoaded, blogPost));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: author$project$Main$ErrorPage('Page \"' + (slugString + '\" not found'))
							}),
...
var author$project$Page$BlogPost$slugParser = A2(
	elm$url$Url$Parser$custom,
	'SLUG',
	A2(elm$core$Basics$composeL, elm$core$Maybe$Just, author$project$Page$BlogPost$Slug));
		...
		[
			...
			A2(
				...
				A2(
					...
					author$project$Page$BlogPost$slugParser))),
			A2(
			elm$url$Url$Parser$map,
			author$project$Route$Post,
			A2(
...
var author$project$Route$urlHashToUrl = function (url) {
...
var author$project$Main$routeFromUrl = F2(
	function (url, model) {
		var maybeRoute = A2(
			elm$url$Url$Parser$parse,
			author$project$Route$parser,
			author$project$Route$urlHashToUrl(url));
		return A2(author$project$Main$setRoute, maybeRoute, model);
	});
...
var author$project$Main$getPageBlogPost = function (page) {
	switch (page.$) {
		case 'HomePage':
			var homeModel = page.a;
			return elm$core$Maybe$Just(homeModel.blogPost);
		case 'BlogPostPage':
			var blogPostModel = page.a;
			return elm$core$Maybe$Just(blogPostModel);
		default:
...
var author$project$Main$initHighlighting = _Platform_outgoingPort(
	'initHighlighting',
	function ($) {
		return elm$json$Json$Encode$null;
	});
var author$project$Main$updateBlogPostContent = F2(
	function (newContent, blogPost) {
		return _Utils_update(
			blogPost,
			{contentString: newContent});
	});
var author$project$Main$updateModelBlogPost = F2(
...
var author$project$Main$viewBlogPostLink = function (blogPost) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Attributes$href(
				'#!/post/' + author$project$Page$BlogPost$slugToString(blogPost.slug))
			]),
		_List_fromArray(
			[
				elm$html$Html$text(blogPost.title)
			]));
};
var elm$html$Html$h2 = _VirtualDom_node('h2');
var author$project$Main$viewPostLinks = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
			...
			A2(
				...
				function (post) {
					return A2(
						...
						_List_fromArray(
							[
								author$project$Main$viewBlogPostLink(post)
							]));
				},
				author$project$Page$BlogPost$posts))
		]));
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$text('absynce.github.io'))
							]))
					])),
				A2(
				elm$html$Html$div,
