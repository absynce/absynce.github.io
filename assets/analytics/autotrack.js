(function () {
  ...
  function Ya(a, b) {
    ...
    history.pushState && window.addEventListener && (this.a = A({
      ...
      fieldsObj: {},
      hitFilter: null
    }, b), this.b = a, this.c = location.pathname + location.search + location.hash, this.H = this.H.bind(this), this.I = this.I.bind(this), this.C = this.C.bind(this), x(history, "pushState", this.H), x(history, "replaceState", this.I), window.addEventListener("popstate", this.C))
  }
  g = Ya.prototype;
  g.H = function (a) {
    var b = this;
  ...
  function Za(a, b) {
    setTimeout(function () {
      var c = a.c,
        d = location.pathname + location.search + location.hash;
  ...
  g.shouldTrackUrlChange = function (a, b) {
    console.log('oldPath', a);
    console.log('newPath', b);
    return !(!a || !b)
  };
  g.remove = function () {
...
//# sourceMappingURL=https://raw.githubusercontent.com/googleanalytics/autotrack/master/autotrack.js.map
